...
export const metadata = {
  title:
    "Top 5 Chess Academies in Rockhampton (2025) – Best Chess Classes for Kids & Teens",
  description:
    "Find the best chess coaching academies in Rockhampton for 2025. See why KingCompiler Chess Academy is the #1 online chess class for Rockhampton families.",
  authors: [{ name: "King Master Team" }],
  openGraph: {
    title: "Top 5 Chess Academies in Rockhampton (2025)",
    description:
      "Find the best chess coaching academies in Rockhampton for 2025. See why KingCompiler Chess Academy is the #1 online chess class for Rockhampton families.",
    images: [
      {
        url: "https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=800&q=80",
        alt: "Rockhampton, Australia",
      },
    ],
  },
};
...
export default function Page() {
  return (
    <article className="prose lg:prose-xl mx-auto py-8">
      <h1>Top 5 Chess Coaching Academies in Rockhampton, Australia (2025)</h1>
      <Image
      ...
      />
      <p>
        Rockhampton’s chess community is growing, with more families discovering
        the benefits of chess for focus and critical thinking. Whether you want
        in-person coaching or flexible online classes, Rockhampton has great
        options for every level.
      </p>
      <p>
        Here are the top 5 chess coaching academies in Rockhampton for 2025—and
      ...
      <p>
        ...
        Rockhampton, with live classes, international coaches, and a suite of
        premium learning tools.
      </p>
      <h3>Why Rockhampton Parents Love KingCompiler:</h3>
      <ul>
        <li>FIDE-rated international coaches</li>
        <li>Live, interactive sessions (no recordings)</li>
        <li>Flexible class times for Rockhampton families</li>
      ...
      <blockquote>
        ...
        skills and confidence have grown so much!” — Rockhampton Parent
      </blockquote>
      <h2>🥈 2. Rockhampton Chess Club</h2>
      <ul>
        <li>
          <b>Location:</b> Rockhampton, QLD
        </li>
        <li>
          <b>Website:</b>{" "}
          <a
            href="https://www.rockhamptonchess.com"
            target="_blank"
            rel="noopener"
          >
            rockhamptonchess.com
          </a>
        </li>
      </ul>
      <ul>
      ...
      <p>
        For Rockhampton families, KingCompiler Chess Academy is the #1 choice
        for online chess classes in 2025. Give your child the gift of chess and
        watch them grow in confidence and skill!
      </p>
      <p className="text-xs text-gray-500 mt-8">
        SEO Tags: RockhamptonChessAcademy, ChessCoachingRockhampton,
        OnlineChessClasses, RockhamptonKidsChess, KingCompilerAcademy,
        FIDEChessAustralia, ChessForKids, LearnChessRockhampton
      </p>
    </article>
  );
}
