...
export const metadata = {
  title:
    "Top 5 Chess Academies in Townsville (2025) – Best Chess Classes for Kids & Teens",
  description:
    "Explore the best chess coaching academies in Townsville for 2025. See why KingCompiler Chess Academy is the #1 online chess class for Townsville families.",
  authors: [{ name: "King Master Team" }],
  openGraph: {
    title: "Top 5 Chess Academies in Townsville (2025)",
    description:
      "Explore the best chess coaching academies in Townsville for 2025. See why KingCompiler Chess Academy is the #1 online chess class for Townsville families.",
    images: [
      {
        url: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=800&q=80",
        alt: "Townsville, Australia",
      },
    ],
  },
};
...
export default function Page() {
  return (
    <article className="prose lg:prose-xl mx-auto py-8">
      <h1>Top 5 Chess Coaching Academies in Townsville, Australia (2025)</h1>
      <Image
        src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=800&q=80"
        alt="Townsville Beach, Australia"
        width={800}
        height={400}
      ...
      />
      <p>
        Townsville is quickly becoming a hub for young chess enthusiasts.
        Whether your child is just starting or looking to compete, the right
        coaching can make all the difference. Both online and local options are
        available for families in Townsville.
      </p>
      <p>
        Here are the top 5 chess coaching academies in Townsville for 2025—and
      ...
      <p>
        ...
        Townsville, with live classes, international coaches, and a suite of
        premium learning tools.
      </p>
      <h3>Why Townsville Parents Choose KingCompiler:</h3>
      <ul>
        <li>FIDE-rated international coaches</li>
        <li>Live, interactive sessions (no recordings)</li>
        <li>Flexible class times for Townsville families</li>
      ...
      <blockquote>
        “KingCompiler’s online classes are engaging and effective. My son’s
        chess skills have improved so much, and he enjoys every lesson!” —
        Townsville Parent
      </blockquote>
      <h2>🥈 2. Townsville Chess Club</h2>
      <ul>
        <li>
          <b>Location:</b> Townsville, QLD
        </li>
        <li>
          <b>Website:</b>{" "}
          <a
            href="https://www.townsvillechessclub.com"
            target="_blank"
            rel="noopener"
          >
            townsvillechessclub.com
          </a>
        </li>
      </ul>
      <ul>
      ...
      <p>
        For Townsville families, KingCompiler Chess Academy is the #1 choice for
        online chess classes in 2025. Give your child the gift of chess and
        watch them grow in confidence and skill!
      </p>
      <p className="text-xs text-gray-500 mt-8">
        SEO Tags: TownsvilleChessAcademy, ChessCoachingTownsville,
        OnlineChessClasses, TownsvilleKidsChess, KingCompilerAcademy,
        FIDEChessAustralia, ChessForKids, LearnChessTownsville
      </p>
    </article>
  );
}
